...
.. container:: site-directory
   ...
   :doc:`Repositories <repositories>`
      Research software, hardware, and publication-linked repositories.

   :doc:`Kevin Dean <kevin-dean>`
      Profile, public CV, selected publications, tools, and profile links.

   :doc:`Teaching <teaching>`
      Courses, workshops, and teaching materials from the lab.
